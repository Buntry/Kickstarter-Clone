# -*- encoding: utf-8 -*-
# stub: sinatra-flash-nicer 0.3.2 ruby lib

Gem::Specification.new do |s|
  s.name = "sinatra-flash-nicer"
  s.version = "0.3.2"
